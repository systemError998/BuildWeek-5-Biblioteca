...
export default function NotFoundPage() {
  ...
  <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
    <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider darkText">
      404
    </p>
    <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider darkText mt-2">
      Page Not Found
    </p>
    <p className="text-lg md:text-xl lg:text-2xl darkText my-12">
      Sorry, the page you are looking for could not be found.
    </p>
    <a
      href="/"
      className="flex items-center space-x-2 darkBlue text-white no-underline hover:bg-blue-700 px-4 py-2 rounded transition duration-150"
      title="Return Home"
    >
      <svg
