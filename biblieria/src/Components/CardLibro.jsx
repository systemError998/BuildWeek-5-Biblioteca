...
export default function CardLibro( {libro} ) {
  ...
  return (
    <>
        <div onClick={()=> navigate("/book/")} className="card w text-center position-relative card rounded-sm" >
            ...
            <div className="pe-none mt-5 position-absolute top-0 start-50 translate-middle-x text-white cont w-full rounded-sm">
                ...
                <p className="card-text font-sans">Copie disponibili: {libro.total_copies}</p>
            </div>
        </div>
    </>
  )
